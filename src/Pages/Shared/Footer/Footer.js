            ...
            <footer className="text-gray-600 body-font">
                <div className="container px-5 pt-20 mx-auto">
                    <div className="flex flex-wrap md:text-left text-center order-first">
                        ...
                        <div className="lg:w-2/4 md:w-1/2 w-full px-4 flex flex-col items-end">
                            <h2 className="title-font font-medium text-gray-900 tracking-widest text-sm mb-3">Enter Your Email to subscribe for latest news</h2>
                ...
                <div className="bg-gray-100">
                    <div className="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
                        ...
                        <p className="text-sm text-gray-500 sm:ml-6 sm:mt-0 mt-4">© 2022 Camera World —
                            <Link to="" href="https://twitter.com/knyttneve" rel="noopener noreferrer" className="text-gray-600 ml-1" target="_blank">@JOY BARUA</Link>
                        </p>
